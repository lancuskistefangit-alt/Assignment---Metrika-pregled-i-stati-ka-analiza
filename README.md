...
Calculator.java – linija 13 – Nigde nije definisano sta se desava ako se unesu zagrade
...
Calculator.java – linija 69 – Calculate(numberList, operationList) nije u skladu sa Java konvencijom imenovanja, aali nije funkcionalna greska
